...
public class TripCollaborationControllerImpl implements TripCollaborationController {
    ...
    public TripCollaborationControllerImpl(
            TripCollaborationRequestService tripCollaborationRequestService,
    ...
    @Override
    public ResponseEntity<ResponseBody<Object>> sendInvitation(
            Long tripId,
            SendTripInvitationDTO request
    ) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.sendInvitation(tripId, request);
    ...
    public ResponseEntity<ResponseBody<Object>> getMyPendingInvitations() {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.getMyPendingInvitations();
    ...
    public ResponseEntity<ResponseBody<Object>> acceptInvitation(Long requestId) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.acceptInvitation(requestId);
    ...
    public ResponseEntity<ResponseBody<Object>> rejectInvitation(Long requestId) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.rejectInvitation(requestId);
    ...
    @Override
    public ResponseEntity<ResponseBody<Object>> requestToJoinTrip(
            Long tripId,
            SendTripJoinRequestDTO request
    ) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.requestToJoinTrip(tripId, request);
    ...
    public ResponseEntity<ResponseBody<Object>> getPendingJoinRequests(Long tripId) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.getPendingJoinRequests(tripId);
    ...
    public ResponseEntity<ResponseBody<Object>> acceptJoinRequest(Long requestId) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.acceptJoinRequest(requestId);
    ...
    public ResponseEntity<ResponseBody<Object>> rejectJoinRequest(Long requestId) {
        CompleteResponse<Object> response =
                tripCollaborationRequestService.rejectJoinRequest(requestId);
