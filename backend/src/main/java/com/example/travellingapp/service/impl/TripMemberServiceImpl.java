...
public class TripMemberServiceImpl implements TripMemberService {
    ...
    public CompleteResponse<Object> addTripMember(
        ...
        try {
            ...
            // Validate role
            TripMemberRoleEnum role = TripMemberRoleEnum.valueOf(
    ...
    public CompleteResponse<Object> updateTripMemberRole(
        ...
        try {
            ...
            TripMemberRoleEnum newRole = tripMemberValidator.validateUpdateTripMemberRoleInput(
                    tripId,
                    tripMemberId,
            ...
            if (tripMember.getRole() == TripMemberRoleEnum.OWNER) {
